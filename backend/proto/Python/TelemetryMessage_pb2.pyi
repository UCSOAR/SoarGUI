...
class TelemetryMessage(_message.Message):
    __slots__ = ["baro", "battery", "combustion_control_status", "flash_info", "gps", "imu", "nos_mass", "padbox_status", "pressure_dmb", "pressure_pbb", "pressure_rcu", "relay_status", "rocket_mass", "source", "target", "temperature_pbb", "temperature_rcu", "temperature_sob"]
